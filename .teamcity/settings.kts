...
project {
    ...
    vcsRoot(GitGithubComAragastmatbExampleTeamcityGitRefsHeadsMaster)
...
object GitGithubComAragastmatbExampleTeamcityGitRefsHeadsMaster : GitVcsRoot({
